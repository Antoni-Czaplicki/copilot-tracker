...
export const env = createEnv({
  server: {
    ...
    GITHUB_COPILOT_BILLING_SCOPE_TYPE: z.enum(['user', 'organization', 'enterprise']).optional().or(emptyStringAsUndefined),
  ...
  runtimeEnv: {
    ...
    GITHUB_COPILOT_BILLING_SCOPE_TYPE: process.env.GITHUB_COPILOT_BILLING_SCOPE_TYPE,
